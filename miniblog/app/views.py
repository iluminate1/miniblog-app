...
class HomePage(DataMixin, ListView):
    ...
    def get_queryset(self):
        return Item.objects.filter(is_published=True).select_related("cat").order_by('-time_create')
...
class AddCategory(RedirectPermissionRequiredMixin, DataMixin, CreateView):
    ...
    def form_valid(self, form):
        self.object = form.save(commit=False)
        self.object.slug = slugify(unidecode(self.object.name))
        self.object.save()
